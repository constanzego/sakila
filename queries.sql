...
*/
SELECT category.name, title, description, release_year, rental_rate, special_features FROM film
...
SELECT actor.actor_id, actor.first_name, film.title, film.release_year FROM film
...
*/
SELECT title, description, release_year, special_features, rating FROM film
JOIN film_actor ON film.film_id = film_actor.film_id
...
*/
SELECT film_actor.film_id, film_actor.actor_id, actor.first_name FROM actor
